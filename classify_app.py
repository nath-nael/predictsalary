...
def get_salary_tier_info():
    ...
    salary_tiers = {
        1: {"range": "$10,000-50,000", "description": "Entry Level"},
        2: {"range": "$50,000 - $65,100", "description": "Junior Level"}, 
        3: {"range": "$65,100 - $85,000", "description": "Mid Level"},
        4: {"range": "$85,000 - $120,000", "description": "Senior Level"},
        5: {"range": "$120,000+", "description": "Executive Level"}
    }
    
    additional_comp_tiers = {
        1: {"range": "$0 - $24,000,000", "description": "Minimal"},
        2: {"range": "$24,000,000 - $48,000,000", "description": "Low"},
        3: {"range": "$48,000,000 - $72,000,000", "description": "Moderate"},
        4: {"range": "$72,000,000 - $96,000,000", "description": "High"},
        5: {"range": "$96,000,000+", "description": "Very High"}
    }
...
def main():
    ...
    if st.button("🔮 Predict Salary & Compensation", type="primary", use_container_width=True):
        ...
        try:
            ...
            salary_ranges = {
                1: (10000, 50000),             # Entry Level: $0 - $50,000
                2: (50000, 65100),         # Junior Level: $50,000 - $65,100
                3: (65100, 85000),         # Mid Level: $65,100 - $85,000
                4: (85000, 120000),        # Senior Level: $85,000 - $120,000
                5: (120000, 1000000)       # Executive Level: $120,000+
            }

            comp_ranges = {
                1: (0, 24000000),          # Minimal: $0 - $24,000,000
                2: (24000000, 48000000),   # Low: $24,000,000 - $48,000,000
                3: (48000000, 72000000),   # Moderate: $48,000,000 - $72,000,000
                4: (72000000, 96000000),   # High: $72,000,000 - $96,000,000
                5: (96000000, 1000000000)  # Very High: $96,000,000+
            }
